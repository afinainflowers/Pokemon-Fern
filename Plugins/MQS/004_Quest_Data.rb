module QuestModule
  ...
  QuestFO1 = {
    :ID => "16",
    :Name => "Farm kept far from harm",
    :QuestGiver => "Doc Cedar",
    :Stage1 => "Get rid of a few pests.",
    :Location1 => "Beetleaf Farm",
    :QuestDescription => "Why do both Doc Cedar and Bete want a teen to get rid of some bugs?",
    :RewardString => "TMs for Attract and Rest. Normally cheap but there is a small shortage."
  }
  ...
  QuestFO2 = {
    ...
    :Stage1 => "Beat the Rocker in the gym.",
    :Location1 => "School floor 1",
    :QuestDescription => "Rockers are starting to get cocky. Time to have a nice, friendly butt-kicking.",
    :RewardString => "Nothing but pure satisfaction. Could just ingore this."
  }
